...
loadAboutTab <- function(){
  ...
  version <- paste0('GliomaAtlas3D ',as.character(packageVersion(.packageName)))
  aboutTab <- tabPanel(title = 'About', id = 'about', 
           titlePanel("The 3D Glioma Atlas"),
           sidebarLayout(
             sidebarPanel(
               h4("Version Information"),
               a(version, href = "https://github.com/SRHilz/GliomaAtlas3D"),
               ...
               p("If you use ATAC-seq data, please also cite:"),
               em("Radhika Mathur, Qixuan Wang, Sriranga Iyyanki, Stephanie Hilz, Chibo Hong, Joanna Phillips, Susan Chang, Feng Yue, Joseph Costello. "),
                  strong(em("EPCO-31. EPIGENOMIC INTRATUMORAL HETEROGENEITY OF GLIOBLASTOMA IN THREE-DIMENSIONAL SPACE.")), 
                  em("Neuro-Oncology, Volume 22, Issue Supplement_2, November 2020, Page ii76, https://doi.org/10.1093/neuonc/noaa215.310"),
               br(),
               br(),
